...
var apartments = createApartment(8, OFFER_TITLES, OFFER_TYPE, OFFFER_CHECKIN_CHECKOUT, OFFER_FEATURES);
...
var articlesFragment = document.createDocumentFragment();
  ...
  for (var i = 0; i < apartments.length; i++) {
    ...
    article.querySelector("h4").textContent = translate[apartment.offer.type];
